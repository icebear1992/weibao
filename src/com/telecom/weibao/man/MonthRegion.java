...
@WebServlet("/man/MonthRegion")
public class MonthRegion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/jsp/telmanJsp/reportTelRegion.jsp").forward(request, response);
		} catch (Exception e) {
