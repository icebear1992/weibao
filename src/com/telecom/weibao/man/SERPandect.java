...
@WebServlet("/man/SERPandect")
public class SERPandect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/jsp/telmanJsp/queryTelSer.jsp").forward(request, response);
		} catch (Exception e) {
