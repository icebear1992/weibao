...
@WebServlet("/man/MonthManu")
public class MonthManu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/jsp/telmanJsp/reportTelManu.jsp").forward(request, response);
		} catch (Exception e) {
