				...
				form.on('submit(formDemo)', function(data) {
				  ...
				  $('#reviewBtn').on('click', function(){
					 ...
					 layer.open({
						  ...
						  ,title: '工单点评'
						  ,area: ['358px', '400px']
						  ,content:'ReviewSER.do?serId='+id  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
						}); 
				  });
				  ...
				  $('#auditBtn').on('click', function(){
					 ...
					 layer.open({
						  ...
						  ,title: '工单审核'
						  ,area: ['358px', '300px']
						  ,content:'AuditSER.do?serId='+id  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
						}); 
				  	});
				});
		</script>
