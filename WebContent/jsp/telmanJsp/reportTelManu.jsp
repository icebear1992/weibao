...
<html>
	...
	<body>
		...
		<div class="layui-inline">
		    ...
		    <div class="layui-input-inline">
		    	<select name="manu" id="manu" class="layui-input search_input" style="width:170px;color:gray;font-family:Microsoft YaHei" >
					<option value="0">请选择厂家</option>
					<c:forEach var="mf" items="${input.mfList}" varStatus="status">
						<option value="${mf.manufacturerName}" />${mf.manufacturerName}</option>
					</c:forEach>
				</select>
		    </div>
		...
		<script>
			...
			table.render({
				  ...
				  ,cols: [[
				      ...
				      ,{field:'MANUFACTURER_NAME', title: '厂商', width:100,sort: true,fixed: true}
