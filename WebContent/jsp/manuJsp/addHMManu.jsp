						...
						<input name="status" value="${input.status }" style="display:none">
					 	...
					 	<div class="layui-row">
						  ...
						  <fieldset class="layui-elem-field">
							  <legend>硬件种类 &nbsp;&nbsp;&nbsp;<button class="layui-btn layui-btn-primary" lay-submit="" lay-filter="submit">提交工单</button></legend>
							...
							<div class="layui-inline">
							  ...
							  <div class="layui-inline">
							    <label class="layui-form-label">需修数量</label>
							    <div class="layui-input-inline">
								...
								<br><br>
							<div class="layui-inline">
								<label class="layui-form-label">修复数量</label>
								<div class="layui-input-inline">
									<input type="text" name="fieldservDuration" lay-verify="numberdot" placeholder="如：5" autocomplete="off" class="layui-input">
								</div>
								</div>
