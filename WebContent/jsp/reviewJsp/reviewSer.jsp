...
<html>
	...
	<body>
		<div style="padding: 20px;" id="main">
			<form class="layui-form" role="form" action='ReviewSER.do' method="post" id="myform">
					<input value="${serId }" id="serId" name="serId" type="hidden"/>
						<div class="container">
							<input name="serviceSatisfaction" hidden="" id="serviceSatisfaction"/>
							<input name="resultSatisfaction" hidden="" id="resultSatisfaction"/>
								<span>服务响应及时度：</span>
				   ...
				   <div class="layui-form-item">
					...
					<div class="layui-form-item layui-form-text">
					  ...
					  <button style="display:none" class="layui-btn" id="submit">提交</button>
		...
		function test1(myvalue){
			document.getElementById("serviceSatisfaction").value=myvalue;
		...
		function test2(myvalue){
			document.getElementById("resultSatisfaction").value=myvalue-5;
			...
			layui.use(['element','form','layer','table','jquery'], function() {
				...
				$('#submitBtn').on('click', function(){
					window.parent.location.href="ViewSer?serId="+id+"&msg=203";
				});
